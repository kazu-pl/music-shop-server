...
import { WriteStream } from "./fs-capacitor"; // użycie tego z tego katalogu ./fs-capacitor (skopiowane tylko zamieniłem `type` na `commonjs` w package.json) sprawia że da się uruchomić server ale ładuje się w nieskończoność
...
/** @typedef {import("./GraphQLUpload.ts").default} GraphQLUpload */
